...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.AuthDataSource>(() => _i8.AuthDataSourceImpl(
          gh<_i4.GoogleSignIn>(),
          gh<_i3.CollectionReference<Object?>>(),
        ));
    gh.lazySingleton<_i9.AuthRepo>(
        () => _i10.AuthRepoImpl(gh<_i8.AuthDataSource>()));
    gh.factory<_i11.AuthUseCase>(() => _i11.AuthUseCase(gh<_i9.AuthRepo>()));
    gh.factory<_i12.AuthenticationBloc>(
        () => _i12.AuthenticationBloc(gh<_i11.AuthUseCase>()));
    gh.factory<_i13.GetCategoriesUseCase>(
        () => _i13.GetCategoriesUseCase(gh<_i6.AddTransactionsRepositories>()));
    gh.factory<_i14.AddTransactionSheetCubit>(
        () => _i14.AddTransactionSheetCubit(gh<_i13.GetCategoriesUseCase>()));
    return this;
  }
}

class _$MainCollectionRef extends _i15.MainCollectionRef {}
