...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i14.AuthenticationBloc>(
        () => _i14.AuthenticationBloc(gh<_i13.AuthUseCase>()));
    ...
    gh.factory<_i17.HomeScreenBloc>(
        () => _i17.HomeScreenBloc(gh<_i16.GetTransactionsUsecase>()));
    gh.factory<_i18.AddTransactionSheetCubit>(
        () => _i18.AddTransactionSheetCubit(
...
class _$MainCollectionRef extends _i19.MainCollectionRef {}

class _$GoogleModule extends _i20.GoogleModule {}
