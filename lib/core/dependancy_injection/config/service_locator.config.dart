...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i15.GenerateReportUsecase>(
        () => _i15.GenerateReportUsecase(gh<_i6.TransactionsRepositories>()));
    gh.factory<_i16.GetCategoriesUseCase>(
        () => _i16.GetCategoriesUseCase(gh<_i6.TransactionsRepositories>()));
    gh.lazySingleton<_i17.GetTransactionsUsecase>(
        () => _i17.GetTransactionsUsecase(gh<_i6.TransactionsRepositories>()));
    gh.factory<_i18.HomeScreenBloc>(() => _i18.HomeScreenBloc(
          gh<_i17.GetTransactionsUsecase>(),
          gh<_i14.DeleteTransactionUsecase>(),
          gh<_i15.GenerateReportUsecase>(),
        ));
    gh.lazySingleton<_i19.LogoutUseCase>(
        () => _i19.LogoutUseCase(gh<_i11.AuthRepo>()));
    gh.factory<_i20.AddTransactionSheetCubit>(
        () => _i20.AddTransactionSheetCubit(
...
class _$MainCollectionRef extends _i22.MainCollectionRef {}

class _$GoogleModule extends _i23.GoogleModule {}
